...
- guaranteed compatibility with every SQLAlchemy codebase
...
If a migration run fails validation, that is a failed migration result, not a
successful migration. The tool is designed to report that failure clearly.
