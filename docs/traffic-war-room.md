...
| 2026-04-16 22:08 PDT | GitHub release `v0.1.0` created for the public scanner/discovery baseline. | Release URL: `https://github.com/zippertools/sqlalchemy-14-to-20-codemod/releases/tag/v0.1.0`. | Use the release as a public trust marker, not as a broad migration claim. |
