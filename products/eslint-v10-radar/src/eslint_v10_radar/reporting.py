...
from eslint_v10_radar.models import RadarReport
...
def report_to_json(report: RadarReport) -> str:
...
def report_to_html(report: RadarReport) -> str:
    findings = "\n".join(
        f"""
...
<html lang="en">
  <head>
    ...
    <title>ESLint v10 Radar Report</title>
    <style>
      body {{
        background: #f7f8fb;
        color: #182235;
